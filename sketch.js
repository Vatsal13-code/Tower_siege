...
var engine, world, ground, pentagon,slingshot,polygon, polygon_img, stand1, stand2;
...
function setup(){
    ...
    ground = new Ground(450,390,800 ,50);
...
image(polygon_img,pentagon.position.x,pentagon.position.y,40,40);
